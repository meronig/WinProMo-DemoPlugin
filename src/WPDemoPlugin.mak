...
# ADD LINK32 ../../WinPromo/src/Release/WinProMo.lib /nologo /base:0x12000000 /subsystem:windows /dll /machine:I386 /out:"../../Release/DemoPlugin.dll"
LINK32_FLAGS=../../WinPromo/src/Release/WinProMo.lib /nologo /base:0x12000000\
...
# ADD LINK32 ../../WinPromo/src/Debug/WinProMo.lib /nologo /base:0x12000000 /subsystem:windows /dll /debug /machine:I386 /out:"../../Debug/DemoPlugin.dll"
LINK32_FLAGS=../../WinPromo/src/Debug/WinProMo.lib /nologo /base:0x12000000\
 /subsystem:windows /dll /incremental:yes /pdb:"$(OUTDIR)/DemoPlugin.pdb" /debug\
 /machine:I386 /out:"../../Debug/DemoPlugin.dll"\
 /implib:"$(OUTDIR)/DemoPlugin.lib" 
LINK32_OBJS= \
	"$(INTDIR)\StdAfx.obj" \
	"$(INTDIR)\WPDemoCmdHandler.obj" \
